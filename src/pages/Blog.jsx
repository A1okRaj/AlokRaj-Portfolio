  ...
  const defaultPosts = [
    {
      ...
      text: "My journey of creating AI-powered applications and solving practical challenges using Machine Learning.",
    },
    {
      id: 2,
      title: "Google Cloud Study Jam Experience",
      text: "Key learnings and hands-on experience gained through Google Cloud and GDG community programs.",
    },
    {
      id: 3,
      title: "My Web Development Journey",
      text: "From HTML & CSS to React, exploring the path of becoming a full-stack developer.",
    },
    {
      id: 4,
      title: "Lessons from Hackathons & Events",
      text: "Skills, teamwork, and problem-solving experiences gained through hackathons and tech events.",
    },
  ];
  ...
  return (
    ...
    >
      <motion.h2
        ...
        transition={{ duration: 0.6 }}
      >
        ✍️ Tech Insights & Learning Journey
      </motion.h2>
      <p className="blog-sub">
        Sharing my experiences, projects, and learnings in AI, Web Development, and Software Engineering.
      </p>
