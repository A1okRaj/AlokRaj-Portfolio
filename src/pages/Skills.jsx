...
const ROWS = [
  [
    ...
    { title: "Databases & Tools", items: ["MySQL", "MongoDB", "Git", "GitHub", "VS Code", "Figma", "Canva"] },
    { title: "Frameworks & Libraries", items: ["React", "Bootstrap", "Framer Motion"] },
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Leadership", "Teamwork", "Problem Solving", "Communication", "Event Management"],
    },
  ],
];
